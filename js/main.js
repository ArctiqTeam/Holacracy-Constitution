function formReply(replying_to_id, include_index) {
    document.getElementById(replying_to_id).value = include_index;
    document.getElementById('comment-form').scrollIntoView();
    document.getElementById('cancel-comment-reply-link').classList.remove("w3-hide");
    return false;
    // document.getElementById(replying_to_id).innerHTML = include_index;
}

function cancelReply(replying_to_id) {
    document.getElementById(replying_to_id).value = '';
    document.getElementById('cancel-comment-reply-link').classList.add("w3-hide");
...
$(function () {
    ...
    var LightLightBox = function () {
        ...
        this.template = {
            ...
            caption: '<div id="' + this.ids.caption + '" style="position: absolute; visibility: hidden; padding: 15px; bottom: 0; left: 0; color: #fff; background: #000; box-sizing: border-box; background: rgba(0, 0, 0, ' + this.options.overlayOpacity + ')"></div>'
        };
